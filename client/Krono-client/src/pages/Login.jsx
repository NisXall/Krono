    ...
    return (
        <div className="max-w-md mx-auto mt-20 bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            <div className="text-center mb-8">
                <h2 className="text-3xl font-extrabold text-purple-900 mb-2">Welcome Back</h2>
                <p className="text-purple-500">Sign in to your Krono account</p>
            </div>
                    ...
                    <>
                        <div>
                            ...
                            <input
                                type="email"
                                required
                                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-700 focus:border-purple-700 transition shadow-sm"
                                value={email}
